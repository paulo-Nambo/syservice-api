...
import com.paulo.syservice.service.TecnicoService;
@CrossOrigin("*")// sem essa motação, a API nao pode consumir o frot_and
@RestController
@RequestMapping(value = "/tecnicos") // and point inicial
public class TecnicoResource {
	...
	public ResponseEntity<List<TecnicoDTO>> findAll() {
		 ...
		 * ArrayList<>(); for(Tecnico obj : list) { listDTO.add(new TecnicoDTO(obj)); }
