...
import com.paulo.syservice.service.ClienteService;
@CrossOrigin("*")
@RestController
@RequestMapping(value = "/clientes") // and point inicial
public class ClienteResource {
	...
	public ResponseEntity<List<ClienteDTO>> findAll() {
		...
		/*
		 * List<Cliente> list = service.findAll(); List<ClienteDTO> listDTO = new
		 * ArrayList<>(); for(Cliente obj : list) { listDTO.add(new ClienteDTO(obj)); }
